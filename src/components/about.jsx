  ...
  return (
    ...
    >
      ...
      <div className="mt-6 text-lg leading-relaxed">
        <p className="mb-4">
          I'm <span className="font-semibold text-brand">Abdallah Masudi</span>, a passionate web developer with a background in statistics and a love for building clean, user-friendly digital experiences.
        </p>
        <p className="mb-4">
